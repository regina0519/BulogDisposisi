...
class ScreenAdminFungsiEdit extends Component {
    myDataBU = [];
    constructor(props) {
                        ...
                        <View style={{ margin: 5, flexGrow: 1, flexShrink: 1, justifyContent: 'center' }}>
                            <View style={[styles.ContentContainer, { height: 'auto', padding: 10 }]}>
                                <ScrollView style={{ width: '100%', paddingHorizontal: 10 }}>
                                    <Text style={Global.customStyles.Label}>Keterangan Fungsi</Text>
                                    <TextInput
                                        value={this.state.myData['ket_fungsi']}
                                        onChangeText={(ket_fungsi) => {
                                            ket_fungsi = MyFunctions.validateString(ket_fungsi);
                                            let arr = this.state.myData;
                                            arr['ket_fungsi'] = ket_fungsi;
...
AppRegistry.registerComponent('ScreenAdminFungsiEdit', () => ScreenAdminFungsiEdit);
export default ScreenAdminFungsiEdit;